...
public interface AccreditationApi {
    ...
    @ResponseBody ResponseEntity<AccreditationResponseDTO> addNewAccreditation(@RequestBody AccreditationDTO accreditationDTO) throws InvalidAccreditationRequestBodyException, PointOfSaleNotFoundException;
